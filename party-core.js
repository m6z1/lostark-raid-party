(function (root, factory) {
  ...
  const SYNERGIES = {
    crit: { label: '치명타 적중률', classes: ['배틀마스터', '스트라이커', '데빌헌터', '건슬링어', '아르카나'] },
    critDamage: { label: '치명타 피해 증가', classes: ['창술사'] },
    armor: { label: '방어력 감소', classes: ['디스트로이어', '워로드', '블래스터', '스카우터', '서머너', '리퍼'] },
    positional: { label: '헤드/백어택 피해', classes: ['워로드', '블레이드', '환수사'] },
    damage: { label: '피해 증가', classes: [
      '버서커', '슬레이어', '발키리', '가디언나이트', '인파이터', '기공사', '브레이커',
      '호크아이', '소서리스', '데모닉', '소울이터', '기상술사', '차원술사',
    ] },
  };
