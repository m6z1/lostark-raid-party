(function (root, factory) {
  ...
  const SYNERGIES = {
    crit: { label: '치명타 적중률 10%', classes: ['배틀마스터', '스트라이커', '데빌헌터', '건슬링어', '아르카나', '기상술사'] },
    critDamage: { label: '치명타 피해 8%', classes: ['창술사', '홀리나이트', '발키리'] },
    armor: { label: '방어력 감소 12%', classes: ['디스트로이어', '블래스터', '서머너', '리퍼', '환수사', '차원술사'] },
    attack: { label: '공격력 증가 6%', classes: ['기공사', '스카우터', '도화가'] },
    positional: { label: '헤드/백어택 피해 5%', classes: ['워로드', '블레이드'] },
    damage: { label: '피해 증가 4~6%', classes: [
